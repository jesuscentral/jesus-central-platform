...
export default function Footer() {
  const footerSections: FooterSection[] = [
    {
      ...
      links: [
        ...
        { label: "Wat We Geloven", href: "/wat-we-geloven" },
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Zondagsdienst", href: "/zondagsdienst" },
        { label: "Connect Groepen", href: "/connect-groepen" },
      ],
    },
    {
      title: "Meedoen",
  ...
  const socialLinks: SocialLink[] = [
    {
      label: "Instagram",
      href: "https://instagram.com/jesuscentral",
      icon: (
    ...
    {
      label: "Facebook",
      href: "https://facebook.com/jesuscentral",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      label: "YouTube",
      href: "https://youtube.com/@jesuscentral",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      label: "Spotify",
      href: "https://open.spotify.com/show/jesuscentral",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
