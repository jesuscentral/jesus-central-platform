  ...
  return (
    ...
    >
      <div className="md:col-span-5">
        <div className="inline-flex items-center gap-2 rounded-md bg-boldness px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-freedom">
          Wat wij geloven
        </div>
        <h2 className="mt-3 text-4xl leading-[1.05] tracking-wide text-boldness sm:text-5xl">
          {blok.statement}
        </h2>
        <div className="mt-4 rounded-2xl border border-boldness/10 bg-white/70 p-4 sm:p-5">
          <div className="mb-2 inline-flex items-center gap-2 text-boldness/70">
