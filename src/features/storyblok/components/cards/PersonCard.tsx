    ...
    >
      ...
      <div
        className={cn(
          ...
          isExpanded ? "min-h-[500px]" : "aspect-[3/4]"
        )}
      >
        {/* Image Layer */}
        <div
        ...
        <div
          className={cn(
            "absolute inset-0 z-10 bg-gradient-to-t from-boldness via-boldness/70 to-transparent transition-opacity duration-500",
            isExpanded ? "opacity-96" : "opacity-0"
          )}
        />

        {/* About content overlay - appears on image (MOBILE: takes full space) */}
        {isExpanded && hasAbout && (
          <div className="absolute inset-0 z-20 flex flex-col p-4 pb-16 pt-14 md:justify-end md:p-8 md:pb-8 md:pt-8">
      ...
      {!isExpanded && (
        <div className={cn("relative p-5 md:p-8")}>
