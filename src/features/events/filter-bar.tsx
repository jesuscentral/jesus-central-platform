...
export default function FilterBar({
  ...
  return (
    <header className="relative overflow-hidden bg-freedom">
      <div className="absolute inset-0 bg-gradient-to-b from-boldness/10 to-transparent" />
      <div className="relative mx-auto max-w-6xl px-4 py-12">
        <motion.h1
          initial={{ opacity: 0, y: 12 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-4xl font-extrabold tracking-tight text-boldness sm:text-5xl"
        >
          Events & Diensten
        </motion.h1>
        <p className="mt-3 max-w-2xl text-boldness/80">
        ...
        {enableFilters && (
          <div className="mt-6 flex flex-wrap items-center gap-3">
            {/* Tabs */}
            <div className="inline-flex rounded-full bg-white/70 p-1 ring-1 ring-boldness/10 backdrop-blur">
              {[
                { k: "alles", label: "Alles" },
