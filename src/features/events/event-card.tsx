  ...
  const card = (
    <Link href={event.full_slug}>
      <motion.article
        ...
        whileHover={{ y: -2 }}
        className="group relative isolate overflow-hidden rounded-3xl border border-white/10 bg-boldness shadow-2xl h-full flex flex-col justify-between"
      >
        <div className="relative aspect-[16/9] w-full overflow-hidden">
          ...
          <div className="absolute right-4 top-4 grid h-16 w-16 place-items-center rounded-2xl border border-white/10 bg-white/10 backdrop-blur-sm">
            <div className="text-center leading-none">
              <div className="text-xs uppercase tracking-wide text-freedom/80">
                {month}
              </div>
              <div className="text-2xl font-bold text-freedom">{day}</div>
              <div className="text-[10px] uppercase tracking-wide text-freedom/70">
                {weekday}
              </div>
            </div>
          </div>
        ...
        <div className="p-5 sm:p-6">
          <div className="mb-2 flex items-center gap-2 text-xs text-freedom/70">
          ...
          <h3 className="line-clamp-2 font-['TGS Perfect Condensed',Oswald,Impact,sans-serif] text-2xl tracking-wide text-freedom sm:text-3xl">
            {event.content.title}
          </h3>
          <small className="text-xs text-freedom/70">
            {event.content.location}
          </small>
          <p className="mt-2 line-clamp-3 font-['Fira Sans',system-ui,sans-serif] text-sm leading-relaxed text-freedom/80">
            {event.content.description}
          </p>

          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {event.content.speaker && (
              <div className="flex items-center gap-2 text-sm text-freedom">
          ...
          <div className="mt-5 flex items-center justify-between">
            <div className="text-xs uppercase tracking-wide text-freedom/60">
              {isService ? "Samenkomst" : "Activiteit"}
            </div>
            <div className="inline-flex items-center gap-1 rounded-2xl border border-white/10 bg-white/5 px-3 py-1 text-sm text-freedom transition-colors group-hover:border-white/20">
              <span>Meer info</span>
